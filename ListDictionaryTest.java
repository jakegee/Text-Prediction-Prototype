...
public class ListDictionaryTest {
	...
	private ListDictionary listDict;
	...
	public void setUp() throws IOException { // Tests that key signature 4663 returns all the words
												 ...
												 // except this time using a private type for ListDictionary
		listDict = new ListDictionary("words.txt");
	}
	@Test
	public void test1() throws IOException {
		...
		Set<String> result = listDict.signatureToWords("4663");
	...
	public void test2() throws IOException { // Tests that key signature 329 returns all the words
		...
		Set<String> result = listDict.signatureToWords("329");
